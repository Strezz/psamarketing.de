...
$second_language = $current_language == "de" ? "EN" : "DE";
$second_language_link = $current_language == "de" ? "en" : "";
/*kz_KZ ru_RU en_US*/

function localized_text($en = '', $de = ''): string
{
    $lang = get_user_locale();
    $current_language = substr($lang, 0, 2);
    return $current_language == "de" ? $de : $en;
}
...
<head>
    ...
    <link rel="stylesheet" id="my-custom-css" href="<?php bloginfo('template_directory') ?>/css/style.min.css">
	<link rel="stylesheet" id="my-custom-css" href="<?php bloginfo('template_directory') ?>/css/style.css">
	<meta name="viewport" content="width=device-width, initial-scale=1">
	<link rel="profile" href="https://gmpg.org/xfn/11">
	<link rel="prefetch prerender" href="<?php bloginfo('template_directory') ?>/img/hero_001.webp" />
        ...
        <header class="header">
            ...
            <div class="header-stars">
                <a class="header-rating df aic" title="Kundenbewertungen & Erfahrungen zu PSA Marketing. Mehr Infos anzeigen." target="_blank" href="https://www.provenexpert.com/psa-marketing/">
                    ...
                    <h6><?php echo the_field('rating', 'option'); ?></h6>
                </a>
            </div>
            <div class="header-lead">
                <div class="container df jcsb aic">
                    ...
                    <div class="header-lead__block">
                        <a href="https://psamarketing.de/e-book/?utm_source=startseite" target="_blank">
                            <button>Kostenlos herunterladen PDF</button>
                        </a>
                    </div>
                </div>
            </div>
                ...
                <div class="container df jcsb aic">
                    ...
                    <div class="header-cta df aic">
                        <div class="header-phone home desktop">
                            <a href="tel:+49 (0) 221 560 94 145" class="df aic">
